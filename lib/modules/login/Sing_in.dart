...
class SingIn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => SingInCubit(),
      child: BlocConsumer<SingInCubit, SingInStates>(
                        ...
                        defaultFormField(
                          ...
                          onSubmit: (value) {
                            if (formKey.currentState!.validate()) {
                              SingInCubit.get(context).userLogin(
                                email: emailController.text,
                                password: passwordController.text,
                              );
                            }
                          },
                          isPassword: SingInCubit.get(context).isPassword,
                          suffixPressed: () {
                            SingInCubit.get(context).changePasswordVisibility();
                          },
                          validate: (value) {
                            if (value.isEmpty) {
